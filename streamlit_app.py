...
Z_CostContact_selected = st.text_input("Enter average cost (Z_CostContact)", Z_CostContact)
Z_Revenue_selected = st.text_input("Enter total earnings (Z_Revenue)", Z_Revenue)
